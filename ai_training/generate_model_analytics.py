...
def main():
    ...
    for (brand, model), grp in groups:
        ...
        # 1. Price vs Mileage scatter (capped at 200 points)
        ...
        # 2. Price vs Year (grouped by year)
        ...
        # 3. Competitors: same body_type, closest median price, top 5
    ...
    print(f"Inserted {len(rows)} model analytics entries")
