...
# 1) Load Data
# -----------------------------
train_path = "ai_training/datasets/train2.csv"
test_path  = "ai_training/datasets/test2.csv"
...
final_model.save_model("ai_training/outputs/final_model_uncertainty_v2.cbm")
print("Saved model to: ai_training/outputs/final_model_uncertainty_v2.cbm")
...
# Save Stage 2 model
stage2_model.save_model("ai_training/outputs/stage2_luxury_model_v2.cbm")
print(f"Saved Stage 2 model to: ai_training/outputs/stage2_luxury_model_v2.cbm")
...
out_path = "ai_training/outputs/test_predictions_with_uncertainty_v2.csv"
...
with open("ai_training/outputs/calibration_info_v2.json", "w") as f:
    json.dump(calibration_info, f, indent=2)

print("Saved calibration info to: ai_training/outputs/calibration_info_v2.json")
